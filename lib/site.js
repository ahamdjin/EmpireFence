export const business = {
  ...
  reviewSummary:
    "Fence installation, gates, block walls, patios, driveways, and turf work across Jurupa Valley and nearby Inland Empire cities.",
};
...
export const highlightStats = [
  ...
  { value: "8", label: "Core fence and exterior service lines" },
  { value: "6+", label: "Nearby Inland Empire cities actively covered" },
];

export const trustPoints = [
  {
    title: "Clear material and layout planning",
    copy:
      "Fence line, gate clearance, transitions, and finished edges are scoped together before the install starts.",
  },
  {
    title: "One contractor across the exterior scope",
    copy:
      "Gates, block walls, patios, driveways, and turf can stay under one coordinated team instead of turning into fragmented handoffs.",
  },
  {
    title: "Fast estimate-first communication",
    copy:
      "The business promise is simple: quick answers, free estimates, and practical recommendations that match the property and budget.",
  },
];
...
export const faqs = [
  {
    ...
    answer:
      "The current offering includes vinyl, wood, chain link, wrought iron, custom fences, cinder block walls, driveways, patios, turf installation, and gate-related work.",
  },
  {
    question: "Do you offer free estimates?",
    answer:
      "Yes. The original site positions free estimates as the main first step, and this rebuild keeps that CTA across the site.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. The service mix extends into patios, driveways, block walls, turf, and related outdoor scope when the perimeter project calls for it.",
  },
];
