...
export const serviceAreas = [
  ...
  },
  {
    ...
    title: "Claremont, CA",
    zipCode: "91711",
    image: "/client/gallery/wrought-iron-fence-gallery-2.jpg",
    intro:
      "Fence installation, fence repair, patio enclosures, railing work, and outdoor improvement services for Claremont homes and businesses.",
    summary:
      "Claremont property owners often need fencing that balances privacy, security, and appearance more carefully. The right fence and gate combination should feel appropriate for the setting, work well in daily life, and add real value without overbuilding the property.",
    seoTitle: "Fence Contractor Claremont, CA | Empire Fence Inc",
    metaDescription:
      "Looking for a trusted fence contractor in Claremont, CA? Empire Fence Inc provides fence installation, fence repair, patio enclosures, railings, and more for homes and businesses. Call +1 951-783-2965 for a free quote.",
    featuredServiceSlugs: ["vinyl-fence", "wrought-iron-fence", "wood-fence", "fence-repairs"],
    trustBullets: [
      "40 years of fencing experience",
      "Residential and commercial service",
      "1-year workmanship warranty",
      "Appearance-focused fence and gate planning",
    ],
  },
  {
    slug: "corona-ca",
    title: "Corona, CA",
    zipCode: "92879",
    image: "/client/gallery/chain-link-perimeter-fence-hillside.jpg",
    intro:
      "Fence installation, fence repair, patio enclosures, railing work, and outdoor boundary upgrades for Corona homes and businesses.",
    summary:
      "Corona property owners need fencing that balances appearance, privacy, durability, and long-term function. Whether the priority is stronger backyard privacy, a cleaner frontage, durable perimeter control, or better gate access, the estimate should reflect the actual property needs.",
    seoTitle: "Fence Contractor Corona, CA | Empire Fence Inc",
    metaDescription:
      "Looking for a trusted fence contractor in Corona, CA? Empire Fence Inc provides fence installation, fence repair, patio enclosures, railings, and more for homes and businesses. Call +1 951-783-2965 for a free quote.",
    featuredServiceSlugs: ["vinyl-fence", "wood-fence", "chain-link-fence", "fence-repairs"],
    trustBullets: [
      "40 years of fencing experience",
      "Residential and commercial service",
      "1-year workmanship warranty",
      "Privacy, security, and frontage fencing",
    ],
  },
  {
    slug: "colton-ca",
    title: "Colton, CA",
    zipCode: "92324",
    image: "/client/gallery/black-industrial-rolling-gate-reference.jpg",
    intro:
      "Fence installation, fence repair, patio enclosures, railing work, and outdoor improvement services for Colton homes and businesses.",
    summary:
      "Colton fencing needs to hold up under everyday use, create privacy where it matters, improve security, and give the property a cleaner and more finished look without overcomplicating the scope.",
    seoTitle: "Fence Contractor Colton, CA | Empire Fence Inc",
    metaDescription:
      "Looking for a trusted fence contractor in Colton, CA? Empire Fence Inc provides fence installation, fence repair, patio enclosures, railings, and more for homes and businesses. Call +1 951-783-2965 for a free quote.",
    featuredServiceSlugs: ["chain-link-fence", "vinyl-fence", "wood-fence", "fence-repairs"],
    trustBullets: [
      "40 years of fencing experience",
      "Residential and commercial service",
      "1-year workmanship warranty",
      "Durable fencing for active everyday use",
    ],
  },
  {
    slug: "eastvale-ca",
    title: "Eastvale, CA",
    zipCode: "92880",
    image: "/client/services/custom-fence/custom-fence-design-2.jpg",
    intro:
      "Fence installation, fence repair, patio enclosures, railing work, and outdoor improvement services for Eastvale homes and businesses.",
    summary:
      "Eastvale property owners often need privacy without losing visual appeal, durable materials that stay presentable, and outdoor improvements that match a newer and well-kept community feel.",
    seoTitle: "Fence Contractor Eastvale, CA | Empire Fence Inc",
    metaDescription:
      "Looking for a trusted fence contractor in Eastvale, CA? Empire Fence Inc provides fence installation, fence repair, patio enclosures, railings, and more for homes and businesses. Call +1 951-783-2965 for a free quote.",
    featuredServiceSlugs: ["vinyl-fence", "wood-fence", "wrought-iron-fence", "fence-repairs"],
    trustBullets: [
      "40 years of fencing experience",
      "Residential and commercial service",
      "1-year workmanship warranty",
      "Clean and finished fencing for newer communities",
    ],
  },
  {
    slug: "highland-ca",
    title: "Highland, CA",
    zipCode: "92346",
    image: "/client/gallery/white-commercial-sliding-gate-entry.jpg",
    intro:
      "Fence installation, fence repair, patio enclosures, railing work, and outdoor improvement services for Highland homes and businesses.",
    summary:
      "Highland fencing often has to balance privacy, durability, and the realities of foothill-area properties. Cleaner backyard separation, stronger side-yard boundaries, and fencing that works well on varied layouts are common priorities here.",
    seoTitle: "Fence Contractor Highland, CA | Empire Fence Inc",
    metaDescription:
      "Looking for a trusted fence contractor in Highland, CA? Empire Fence Inc provides fence installation, fence repair, patio enclosures, railings, and more for homes and businesses. Call +1 951-783-2965 for a free quote.",
    featuredServiceSlugs: ["wood-fence", "vinyl-fence", "chain-link-fence", "fence-repairs"],
    trustBullets: [
      "40 years of fencing experience",
      "Residential and commercial service",
      "1-year workmanship warranty",
      "Fencing that works on varied foothill layouts",
    ],
  },
];
