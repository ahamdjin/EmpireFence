...
export const highlightStats = [
  ...
  { value: "8", label: "Fence and outdoor scopes" },
...
export const trustPoints = [
  ...
  },
  {
    ...
    copy:
      "Gates, walls, patios, driveways, and turf can stay coordinated instead of splitting into scattered handoffs.",
  },
  {
...
export const aboutHighlights = [
  ...
  },
  {
    ...
    title: "Gates, walls, patios, and driveways under one tighter path.",
    copy:
      "The surrounding outdoor pieces can stay coordinated instead of getting split into disconnected handoffs after the fence line is done.",
    image: "/client/driveway-patio.jpg",
  },
];
...
export const featuredProjects = [
  ...
  {
    image: "/client/driveway-patio.jpg",
    eyebrow: "Outdoor scope",
    title: "Driveway and patio work when the frontage needs more than fencing.",
  },
];
...
export const coverageNotes = [
  ...
  },
  {
    ...
    copy: "Walls, patios, driveways, and turf when the property edge needs more than one trade.",
  },
];
...
export const faqs = [
  {
    ...
    answer:
      "Empire Fence handles vinyl, wood, chain link, wrought iron, custom fences, gates, block walls, driveways, patios, and turf installation.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Patios, driveways, block walls, and turf can be bundled when the perimeter project needs a more complete finish.",
  },
];
...
export const galleryCollections = [
  ...
  },
  {
    ...
    copy: "Walls, patio sections, and driveway scope when the frontage needs a more complete finish.",
  },
];
