...
faqs:
  - question: Can wood fencing be built for privacy?
    answer: Yes. Wood is one of the strongest privacy materials because it can be built in full-height, tightly enclosed layouts that block views and define the yard clearly.
  - question: Does Empire Fence handle custom wood layouts?
    answer: Yes. Wood fences can be planned around the style of the property, whether the owner wants a standard privacy run, a cleaner modern line, or something more decorative.
  - question: When does wood make more sense than vinyl?
    answer: Wood usually makes more sense when the owner wants a warmer, more natural appearance, more flexibility in the layout, or a fence that can be customized more heavily around the architecture.
  - question: What affects a wood fence estimate?
    answer: Wood fence pricing usually depends on total footage, board style, height, gate count, removal of old material, grade changes, and whether the project needs decorative details or custom transitions.
---
